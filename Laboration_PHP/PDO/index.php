...
elseif($page == 'blogg') {
	...
	else {$error = 'Inlägget kommer ej visas';}

	require ('resources/templates/' . $template . '.php');
}

// Check if $page is contacts.
elseif($page == 'kontakt') {
	$header = 'Kontakt';
    $content = 'Du kan troligtvis nå oss på epost@labb2.se';
    require ('resources/templates/page-template.php');
}
...
// If not any page, 404 message.
	...
	$header = 'error 404';
	$error = 'Den här sidan kommer inte finnas !';
	require ('resources/templates/page-template.php');
}
?>
